...
public abstract class BaseTest {
    ...
    protected static final String BLAZEMETER_TRN_REPO_URI = ENV.getProperty("blazemeter.trans.repo.uri",
    ...
    public static boolean connectionDetailProvided() {
        ...
        if (BLAZEMETER_TRN_REPO_URI.isEmpty() ||
            ...
            LOG.error("Connection Details test for Cloud Transaction Repository have not been provided.");
